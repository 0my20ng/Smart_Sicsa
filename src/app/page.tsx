    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-emerald-100 p-4">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-green-100 p-8 space-y-6 backdrop-blur-sm">
          ...
          <form className="space-y-4 mt-8">
            <div>
              <input
                type="text"
                placeholder="ID"
                className="w-full px-5 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-green-400 focus:bg-white transition-all text-gray-700 placeholder:text-gray-400"
              />
            </div>
            <div>
              <input
            ...
            <Link href="/main" className="block w-full">
              <button
                type="button"
                className="w-full bg-green-500 hover:bg-green-600 active:bg-green-700 text-white font-medium py-3 rounded-xl shadow-lg shadow-green-500/30 transition-all hover:-translate-y-0.5 mt-2 flex items-center justify-center gap-2"
              >
                로그인
              </button>
            </Link>
          ...
          <button className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 font-medium py-3 rounded-xl transition-all">
          ...
          <div className="flex flex-col items-center justify-center space-y-3 pt-2 text-sm">
            ...
            <Link href="#" className="text-gray-500 hover:text-gray-800 transition-colors pt-2">
              회원가입
            </Link>
          </div>
        </div>
