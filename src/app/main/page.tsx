      ...
      <main className="flex-1 pt-24 pb-10 px-4 sm:px-8 md:px-12 max-w-5xl mx-auto w-full">
        <div className="space-y-8">
          ...
          <div className="flex gap-4 items-center">
            ...
            <button className="bg-[#7CFC00] hover:bg-[#6EEB00] active:scale-95 text-gray-800 font-black py-4 px-8 rounded-2xl border-2 border-green-400 shadow-md transition-all flex flex-col items-center justify-center min-w-[160px] h-[4.5rem]">
              <span>냉장고</span>
              <span>불러오기</span>
            </button>
          </div>
